package com.nomiceu.gregtechdrawers.render.tileentity;
...
public class TileEntityGTDrawersRenderer extends TileEntitySpecialRenderer<TileEntityDrawers> {
	...
	private void renderText(String text, TileEntityDrawers tile, IBlockState state, int slot, EnumFacing side,
		...
		BlockDrawers block = (BlockGTDrawers)state.getBlock();
