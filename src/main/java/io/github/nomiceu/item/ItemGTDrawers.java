package io.github.nomiceu.item;
...
public class ItemGTDrawers extends ItemDrawers implements IItemMeshMapper {
		...
		return Arrays.stream(EnumBasicDrawer.values())
				.map(type -> Pair.of(
						...
						new ModelResourceLocation(
								GTDrawers.MODID + ":basicdrawers_" + type.getName() + "_" + mod + "_" + material,
								"inventory")))
